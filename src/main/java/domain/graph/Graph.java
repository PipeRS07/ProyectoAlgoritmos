...
public interface Graph {
    ...
    //Practice for Exam 2
    public int getVertexDegree(Object element) throws GraphException, ListException;
    public int getGraphDegree() throws GraphException, ListException;
    public int totalEdges() throws GraphException, ListException;
    public int totalEdges(Object element) throws GraphException, ListException;
    public String getEdges(Object element) throws GraphException, ListException;
}
